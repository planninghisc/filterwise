      ...
      <div className="rounded-2xl border bg-white p-5 shadow-sm">
        ...
        <div className="mt-3 grid grid-cols-1 sm:grid-cols-6 gap-3 items-end">
          ...
          <div className="flex gap-2 sm:col-span-4">
            <button onClick={ingest} disabled={ingLoading} className="inline-flex items-center justify-center min-w-[96px] rounded-md bg-[#ea580c] text-white px-4 py-2.5 hover:bg-[#c2410c] disabled:opacity-50">
              {ingLoading ? '수집 중…' : '수집'}
            </button>
